...
public class HtmlReportSupport {
	...
	public static void createHtmlSummaryReport(String browser,
		...
		try {
			...
			writer.write("<img align ='left' src= http://www.cigniti.com/sites/all/themes/venture_theme/logo.png></img>");
			writer.write("</th>");
			writer.write("<th class = 'Logos' colspan='2' > ");
			writer.write("<img align ='right' src= http://www.cigniti.com/sites/all/themes/venture_theme/logo.png></img>");
			writer.write("</th> ");
			writer.write("</tr> ");
